...
export default function Home({ navigation }) {
  ...
  const [userData, setUserData] = useState("user@gmail.com");
          ...
          return (
            <SafeAreaView>
              <View style={styles.drawerHeader}>
                ...
                <Text style={styles.drawerUserId}>Email:{userData.email}</Text>
                <Text style={styles.drawerUserverify}>Verified: {userData.verified ? 'Yes' : 'No'}</Text>
              </View>
      ...
      >
        ...
        <Drawer.Screen
          ...
          options={{
            ...
            drawerIcon: () => <SimpleLineIcons name="user" size={20} color="#808080" />,
          }}
        />
